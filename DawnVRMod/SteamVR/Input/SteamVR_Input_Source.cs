        ...
        public static void Initialize()
        {
            ...
            for (int enumIndex = 0; enumIndex < enumNames.Length; enumIndex++)
            {
                ...
                if (err != EVRInputError.None)
                    MelonLoader.MelonLogger.Error("[SteamVR] GetInputSourceHandle (" + path + ") error: " + err.ToString());

                if (enumNames[enumIndex] == SteamVR_Input_Sources.Any.ToString()) //_: temporary hack
                {
