    ...
    public abstract class SteamVR_Action_Source_Map
    {
        ...
        public virtual void Initialize()
        {
            ...
            if (err != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetActionHandle (" + fullPath.ToLowerInvariant() + ") error: " + err.ToString());
        }
        ...
        private SteamVR_ActionDirections GetActionDirection()
        {
            ...
            if (direction == inLowered)
                ...
                MelonLoader.MelonLogger.Error("[SteamVR] Could not find match for direction: " + direction);
            return SteamVR_ActionDirections.In;
        }
    }
