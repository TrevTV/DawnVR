...
namespace Valve.VR
{
    ...
    /// </summary>
    public class SteamVR_Action_Vector3 : SteamVR_Action_In<SteamVR_Action_Vector3_Source_Map, SteamVR_Action_Vector3_Source>, ISteamVR_Action_Vector3, ISerializationCallbackReceiverC
    {
    ...
    public class SteamVR_Action_Vector3_Source : SteamVR_Action_In_Source, ISteamVR_Action_Vector3
    {
        ...
        public override void UpdateValue()
        {
            ...
            if (err != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetAnalogActionData error (" + fullPath + "): " + err.ToString() + " handle: " + handle.ToString());
