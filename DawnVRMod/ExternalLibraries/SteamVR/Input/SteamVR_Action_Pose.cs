...
namespace Valve.VR
{
    ...
    /// </summary>
    public class SteamVR_Action_Pose : SteamVR_Action_Pose_Base<SteamVR_Action_Pose_Source_Map<SteamVR_Action_Pose_Source>, SteamVR_Action_Pose_Source>, ISerializationCallbackReceiverC
    {
    ...
    public class SteamVR_Action_Pose_Source : SteamVR_Action_In_Source, ISteamVR_Action_Pose
    {
        ...
        public virtual void UpdateValue(bool skipStateAndEventUpdates)
        {
            ...
            {
                MelonLoader.MelonLogger.Error("[SteamVR] GetPoseActionData error (" + fullPath + "): " + err.ToString() + " Handle: " + handle.ToString() + ". Input source: " + inputSource.ToString());
            }
        ...
        public bool GetVelocitiesAtTimeOffset(float secondsFromNow, out Vector3 velocityAtTime, out Vector3 angularVelocityAtTime)
        {
            ...
            if (err != EVRInputError.None)
            {
                MelonLoader.MelonLogger.Error("[SteamVR] GetPoseActionData error (" + fullPath + "): " + err.ToString() + " handle: " + handle.ToString());
