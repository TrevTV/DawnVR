...
namespace Valve.VR
{
    ...
    /// </summary>
    public class SteamVR_Action_Vibration : SteamVR_Action_Out<SteamVR_Action_Vibration_Source_Map, SteamVR_Action_Vibration_Source>, ISerializationCallbackReceiverC
    {
    ...
    public class SteamVR_Action_Vibration_Source : SteamVR_Action_Out_Source
    {
        ...
        //_: fix the active state of out actions
        ...
        public void Execute(float secondsFromNow, float durationSeconds, float frequency, float amplitude)
        {
            ...
            if (err != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] TriggerHapticVibrationAction (" + fullPath + ") error: " + err.ToString() + " handle: " + handle.ToString());
