...
namespace Valve.VR
{
    ...
    /// </summary>
    public class SteamVR_Action_Skeleton : SteamVR_Action_Pose_Base<SteamVR_Action_Skeleton_Source_Map, SteamVR_Action_Skeleton_Source>, ISteamVR_Action_Skeleton_Source, ISerializationCallbackReceiverC
    {
    ...
    public class SteamVR_Action_Skeleton_Source : SteamVR_Action_Pose_Source, ISteamVR_Action_Skeleton_Source
    {
        ...
        public override void UpdateValue(bool skipStateAndEventUpdates)
        {
            ...
            {
                MelonLoader.MelonLogger.Error("[SteamVR] GetSkeletalActionData error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
                return;
            }
            ...
            if (active)
            {
                if (onlyUpdateSummaryData == false)
                {
                    ...
                    if (error != EVRInputError.None)
                        MelonLoader.MelonLogger.Error("[SteamVR] GetSkeletalBoneData error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        public uint GetBoneCount()
        {
            ...
            if (error != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetBoneCount error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        public int[] GetBoneHierarchy()
        {
            ...
            if (error != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetBoneHierarchy error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        public string GetBoneName(int boneIndex)
        {
            ...
            if (error != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetBoneName error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        public SteamVR_Utils.RigidTransform[] GetReferenceTransforms(EVRSkeletalTransformSpace transformSpace, EVRSkeletalReferencePose referencePose)
        {
            ...
            if (error != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetSkeletalReferenceTransforms error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        public EVRSkeletalTrackingLevel GetSkeletalTrackingLevel()
        {
            ...
            if (error != EVRInputError.None)
                MelonLoader.MelonLogger.Error("[SteamVR] GetSkeletalTrackingLevel error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
        ...
        protected void UpdateSkeletalSummaryData(EVRSummaryType summaryType = EVRSummaryType.FromAnimation, bool force = false)
        {
            if (force || this.summaryDataType != summaryDataType && active)
            {
                ...
                if (error != EVRInputError.None)
                    MelonLoader.MelonLogger.Error("[SteamVR] GetSkeletalSummaryData error (" + fullPath + "): " + error.ToString() + " handle: " + handle.ToString());
